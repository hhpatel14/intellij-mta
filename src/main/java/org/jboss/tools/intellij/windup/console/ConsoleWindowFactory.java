...
public class ConsoleWindowFactory implements ToolWindowFactory, DumbAware {
    ...
    private static final String OUTPUT_WINDOW_CONTENT_ID = "WindupOutputWindowContent";
    ...
    public ActionGroup getLeftToolbarActions() {
        ...
        group.add(actionManager.getAction("windup.ChooseConfiguration"));
        group.addSeparator();
        group.add(actionManager.getAction("windup.Install"));
        group.add(actionManager.getAction("windup.Run"));
        group.add(actionManager.getAction("windup.Kill"));
        return group;
    }
}
